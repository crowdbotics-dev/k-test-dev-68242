"""
Django settings for k_test_dev_68242 project.
...
ROOT_URLCONF = 'k_test_dev_68242.urls'
...
WSGI_APPLICATION = 'k_test_dev_68242.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "k_test_dev_68242 API",
    "DESCRIPTION": "API documentation for k_test_dev_68242 App",
    "VERSION": "v1",
}
